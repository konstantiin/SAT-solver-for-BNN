...
val resolve_unit_clause_if_any : cnf_t -> assignment_t -> assignment_t option
val is_conflict : assignment_t -> clause_t -> bool
val unit_propagation : cnf_t -> assignment_t -> assignment_t * clause_t option
...
val cdcl_bf : cnf_t -> assignment_t -> answer_t
